...
function custom_taxonomy_projects()
{
	...
	//unregister_taxonomy_for_object_type('category', 'projects');

	// register_taxonomy('sculptures', 'projects', array(
	// 	'labels'										=> array(
	// 		'name'										=> 'Sculptures',
	// 		'menu_name'								=> 'Sculptures',
	// 		'singular_name'						=> 'Sculpture',
	// 		'search_items'						=> 'Search Sculptures',
	// 		'all_items'								=> 'All Sculptures',
	// 		'parent_item'							=> null,
	// 		'parent_item_colon'				=> null,
	// 		'edit_item'								=> 'Edit Sculptures',
	// 		'update_item'							=> 'Update Sculptures',
	// 		'add_new_item'						=> 'Add New Sculptures',
	// 		'new_item_name'						=> 'New Sculptures Name',
	// 		'seperate_items_with_commas'	=> 'Seperate Sculptures With Commas',
	// 		'add_or_remove_items'					=> 'Add or remove Sculptures',
	// 		'choose_from_most_used'				=> 'Choose from the most used Sculptures',
	// 		'not_found'										=> 'No Sculptures Found',
	// 	),
	// 	'hierarchical'							=> false,
	// 	'show_ui'										=> true,
	// 	'show_admin_column'					=> true,
